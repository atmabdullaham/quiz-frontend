        ...
        <div className="space-y-6">
          ...
          <div className="border-l-4 border-blue-500 pl-4">
            <h2 className="text-xl font-semibold mb-4 text-blue-600">
              📱 Frontend Data (from React Context)
            </h2>
            ...
            {backendLoading ? (
              ...
              <>
                <div>
                  <h3 className="font-medium text-gray-700">User Email:</h3>
                  <p className="text-gray-700 font-mono">
                    {backendUserData?.email || "❌ No email"}
                  </p>
                </div>
          ...
          <div className="border-l-4 border-purple-500 pl-4 bg-purple-50 p-4 rounded">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p
                  className={`font-bold ${dbUser?.role === "admin" ? "text-green-600" : "text-red-600"}`}
                >
              ...
              <div>
                ...
                <p
                  className={`font-bold ${backendUserData?.role === "admin" ? "text-green-600" : "text-red-600"}`}
                >
              ...
              <div>
                ...
                <p
                  className={`text-lg font-bold ${
                    dbUser?.role === backendUserData?.role
                      ? "text-green-600"
                      : "text-orange-600"
                  }`}
                >
          ...
          <div className="bg-blue-50 border border-blue-200 p-4 rounded">
            ...
            <ol className="text-sm text-blue-800 space-y-2 list-decimal list-inside">
              <li>
                If role shows as "user" above, go to{" "}
                <a href="/admin/setup" className="underline font-bold">
                  Admin Setup
                </a>{" "}
                to promote
              </li>
              <li>
                After promoting, <strong>log out completely</strong> (button in
                navbar dropdown)
              </li>
              <li>
                Clear browser cache:{" "}
